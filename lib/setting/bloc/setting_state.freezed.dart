...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String errorMessage, bool isLoading, MUser? user});
}
...
class _$SettingStateImpl implements _SettingState {
  const _$SettingStateImpl(
      {this.errorMessage = '', this.isLoading = false, this.user});
  ...
  @override
  String toString() {
    return 'SettingState(errorMessage: $errorMessage, isLoading: $isLoading, user: $user)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, errorMessage, isLoading, user);
...
abstract class _SettingState implements SettingState {
  const factory _SettingState(
      {final String errorMessage,
      final bool isLoading,
      final MUser? user}) = _$SettingStateImpl;
